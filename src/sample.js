...
const title = React.createElement(
  "h1",
  { id: "heading" },
  "it is not ending it is starting here"
);
root.render(title);
...
const secondParent = React.createElement("div", { id: "parent2" }, [
  "Its just message for checking first",
  React.createElement(
    "div",
    { id: "firstChildforparent" },
    "now its just show message First Tag"
  ),
  React.createElement(
    "div",
    { id: "secondChildforparent" },
    "now its just show message Second Tag"
  ),
]);
...
const headingTag = (
  <h1 id="Heading">
    <div id="firstnested">Write Your Heading</div>
  </h1>
);
console.log(headingTag, "heading"); // this will give to us one Object. why beacuse it is not HTML tag it is JSX
